...
impl EngineClient {
    ...
    fn rpc_client<N: Network>(addr: Url, jwt: JwtSecret) -> RootProvider<N> {
    ...
    /// * `rollup_boost` – Rollup boost engine API implementation
    pub fn new_http(
        engine: Url,
        l1_rpc: Url,
        cfg: Arc<RollupConfig>,
        ...
        Self { engine, l1_provider, cfg, rollup_boost }
    }
